...
You need Ruby 1.9 MRI or compatible installed, because the parser is written
in Ruby 1.9 (not in mruby).
...
The setup.sh script compiles mruby, mrblib, the runner executable.
